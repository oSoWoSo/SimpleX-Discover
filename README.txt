...
_Group Discovery_ (Original group index - Hopefully will include updates on this index as well):
!2 delete!
...
_Anon Network_ (Discover people, groups, share interests):
!2 direct!
!2 delete!
...
_SimpleX Desktop_ (Simplex Desktop GUI):
...
_SimpleX UI/UX_ (Simplex User Experience and Interface):
!2 direct!
!2 delete!
...
_DistroHopper_ (in beta, dh.osowoso.xyz - Quickly download, create and run VM of any operating system):
...
_Privacy Guides_ (Public SimpleX Group):
...
_Drugs_ (Experimental group. "Sensitive topic" testing moderation - Aims to achieve non-harmful anecdotes, with minimal moderation needed.):
...
_Czech group_ (Momentalne jen o prekladu SimpleX aplikaci a webu):
